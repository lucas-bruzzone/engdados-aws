...
def renderiza_template():
    ...
    with open(_get_abs_path('Aula2/Jinja/redshift.yml.j2'), 'r') as f:
        redshift_yaml = f.read()

    with open(_get_abs_path('Aula2/Jinja/config.yml'), 'r') as f:
    ...
    with open(_get_abs_path('Aula2/Jinja/redshift.yml'), 'w') as f:
